...
zodi = np.load('Data/zodi_{}.npy'.format(zodi_pattern)) # zodiacal light by wavelength(electron)
...
def main():
    ...
    print('ZODI pattern: {}'.format(zodi_pattern))
    ...
    np.save('Result/sub_evaluation_both_zodi_{}.npy'.format(zodi_pattern), sub_evaluation_1)
    np.save('Result/sub_evaluation_back_zodi_{}.npy'.format(zodi_pattern), sub_evaluation_2)
    np.save('Result/sub_sigma_both_zodi_{}.npy'.format(zodi_pattern), sub_sigma_1)
    np.save('Result/sub_sigma_back_zodi_{}.npy'.format(zodi_pattern), sub_sigma_2)
    print('Success')
