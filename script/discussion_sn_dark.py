...
dark = 5.0                                  # dark current value(electron/sec)
n = 100                                     # repeat times
T_star_len = 4
t_exp = 60                                  # exposure time(sec)
times = 60                                  # number of transmissions
Q = dark*t_exp                              # dark current value(electron/read)
...
def main():
    ...
    print('dark current: {}'.format(int(Q)))
    ...
    np.save('Result/sub_evaluation_both_dark_{}.npy'.format(int(Q)), sub_evaluation_1)
    np.save('Result/sub_evaluation_ref_dark_{}.npy'.format(int(Q)), sub_evaluation_2)
    np.save('Result/sub_sigma_both_dark_{}.npy'.format(int(Q)), sub_sigma_1)
    np.save('Result/sub_sigma_ref_dark_{}.npy'.format(int(Q)), sub_sigma_2)
    print('Success')
